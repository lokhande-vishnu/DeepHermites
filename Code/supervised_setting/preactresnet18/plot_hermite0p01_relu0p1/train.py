...
def plot_fid_shade(axs, plot_type, label, idx):
    if label == 'h4':
        ...
        cl = 'r'
        label_name = 'relu'
        dir_name = os.path.join(relu_dir, 'relu_exp{}/stat/preactresnet_18_relu_exp{}.csv')
...
if __name__ == '__main__':
    ...
    fig.tight_layout()
    fig.savefig('{}/preactresnet18_hermitelr0p01_relulr0p1_train.png'.format(image_folder), bbox_inches='tight')
